...
# Global Variables Way #2 Work in Progress (Might not need it)
...
# Velocity Knob Position Need to Play with PPS
@app.callback(
...
def position_mode(switch_position, step_position, address, acceleration, step_velocity, step_size, velocity_position, com):
    ...
    if (switch_position == True):
        ...
        velo = "/{}V{}L{}A{}RR\r".format(address,
...
if __name__ == '__main__':
    # ser = serial.Serial("COM21") global var set
    # defaultset() global var set
